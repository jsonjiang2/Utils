...
<div class="container">
    <form id="updateForm" action="" method="post" class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-3">
                <input type="text" name="bankname" id="bankname" class="form-control" value="${bankCodeName.bankname}" />
        ...
        <div class="form-group">
            ...
            <div class="col-sm-3">
                <input type="text" name="bankcode" id="bankcode" class="form-control" value="${bankCodeName.bankcode}" />
        ...
        <div class="form-group">
            ...
            <div class="col-sm-3">
                <textarea rows="3" class="form-control" name="remark" id="remark">${bankCodeName.remark}</textarea>
                <span id="remarkError" style="color:red"></span>
            </div>
        </div>
        <input type="hidden" name="id" value="${bankCodeName.id}"/>
    </form>
</div>
