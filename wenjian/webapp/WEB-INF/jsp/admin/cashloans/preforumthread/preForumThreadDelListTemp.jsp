				...
				<tbody>
					<c:forEach items="${pagehelper.list}" var="item" varStatus="status">
						<tr class="text-center">
							...
							<td>
								<a href="${basePath}/admin/cashloans/preForumThread/delList?authorid=${item.authorid}"  style="color:blue;">
 							...
 							<c:if test="${item.fid eq '101'}">
 	 						...
 	 						<td>
	 							<a href="${basePath}/admin/cashloans/preForumThread/delList?fid=${item.fid }"  style="color:blue;">
							...
							<td>
 							...
 							<td>
 								<a class="btn btn-default" href="${basePath}/admin/cashloans/preForumThread/editorThreadShow?tid=${item.tid}&liststr=delList">编辑</a>
