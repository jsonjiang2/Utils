				...
				<tbody>
					<c:forEach items="${pagehelper.list}" var="item" varStatus="status">
						<tr class="text-center">
							...
							<td>
								<a href="${basePath}/admin/cashloans/preForumThread/list?authorid=${item.authorid }"  style="color:blue;">
							...
							<td>
  							...
  							<td>
 								<a class="btn btn-default" href="${basePath}/admin/cashloans/preForumThread/editorThreadShow?tid=${item.tid}&liststr=list">编辑</a>
