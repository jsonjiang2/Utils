		...
		<div class="row clearfix">
			...
			<form method="post" class="form-inline" id="form-select"
				...
				<div class="form-group">
					...
					<a  href="/ueditortest.jsp" class="btn btn-default" style="width: 100px;">发帖测试</a>
				</div>
			</form>
			<div style="margin-top: 20px;"></div>
 			<jsp:include page="/WEB-INF/jsp/admin/cashloans/preforumthread/preForumThreadViewListTemp.jsp"></jsp:include>
		</div>
	</div>
	<!-- 引入模态框 -->
