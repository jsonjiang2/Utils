...
$(function(){
  ...
  $(".wdbSubmit").on("click",function(){
	  ...
	  console.log(JSON.stringify(dataObj))
  	  var action = basePath+"/admin/cashloans/preForumThread/editorThread";
	  var callback = function(data){
 		  alert(data.message);
		  if(data.code =="88"){
			  window.location.href=basePath+"/admin/cashloans/preForumThread/"+wdbliststr;
		  } 
	  }
...
function uploadImage(files,insert){
	...
	var action = basePath+"/admin/cashloans/preForumThread/uploadImageByThread";
		$.ajax({
        url: action,
        data: formFile,
        type: "Post",
