...
<head>
    ...
    <script>
        ...
        function selectById(id) {
            var action = "${pageContext.request.contextPath}/admin/cheatBackDepositAccount/selectById/" + id;
...
<div class="container" style="width:80%">
    <div class="row clearfix">
        <div class="col-md-12 column">
            <form action="${pageContext.request.contextPath}/admin/cheatBackDepositAccount/lists" method="post" role="form"
                  id="conditionForm">
                ...
                <div class="col-md-9 form-inline" style="margin-top:15px;">
                    <div class="form-group">
                        <label>用户名:</label>
                        <input type="text" class="form-control" name="username" id="username" value="${cheatBackDepositAccount.username}" placeholder="输入用户名查询">&nbsp;&nbsp;
                    </div>
                </div>
            ...
            <table class="table  table-hover" id="personList_table">
                ...
                <c:forEach items="${pagehelper.list }" var="entity" varStatus="tendsta">
                    <tr class="text-center">
                        ...
                        <td>
                            <c:choose>
                                <c:when test="${not empty entity.platformname}">
                                    ${entity.platformname}
                                </c:when>
