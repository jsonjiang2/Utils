...
<head>
    ...
    <script>
        ...
        function selectById(id) {
            var action = "${pageContext.request.contextPath}/admin/cheatBackDepositInEx/selectById/" + id;
...
<div class="container" style="width:80%">
    <div class="row clearfix">
        <div class="col-md-12 column">
            <form action="${pageContext.request.contextPath}/admin/cheatBackDepositInEx/lists" method="post" role="form"
                  id="conditionForm">
                ...
                <div class="col-md-9 form-inline" style="margin-top:15px;">
                    <div class="form-group">
                        <label>用户名:</label>
                        <input type="text" class="form-control" name="username" id="username" value="${cheatBackDepositInEx.username}" placeholder="输入用户名查询">&nbsp;&nbsp;
                    </div>
                    <div class="form-group">
                        <label>关联流水号:</label>
                        <input type="text" class="form-control" name="borderno" id="borderno" value="${cheatBackDepositInEx.borderno}" placeholder="输入关联流水号">&nbsp;&nbsp;
                    </div>
                    <div class="form-group">
                        <label>业务类型:</label>
                        <select class="form-control" name="type" id="type">
                            <option value="">全部</option>
                            <option value="1" <c:if test="${cheatBackDepositInEx.type==1}">selected</c:if>>缴纳</option>
                            <option value="2" <c:if test="${cheatBackDepositInEx.type==2}">selected</c:if>>退款</option>
                            <option value="3" <c:if test="${cheatBackDepositInEx.type==3}">selected</c:if>>手充</option>
                            <option value="4" <c:if test="${cheatBackDepositInEx.type==4}">selected</c:if>>充值</option>
                        </select>&nbsp;&nbsp;
                    </div>
                </div>
