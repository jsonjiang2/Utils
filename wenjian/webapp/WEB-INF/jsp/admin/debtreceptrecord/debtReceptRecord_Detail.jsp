...
<div class="col-md-12" id="rechargei">
    ...
    <div class="form-group ">
        ...
        <lable class="col-md-4">
            ...
            <c:if test="${entity.receptstatus==2 }"><span style="color: blue">成功</span></c:if>
        </lable>
    </div><br>
    <div class="form-group ">
        <lable class="col-sm-4 text-right">出让手续费：</lable>
        <lable class="col-md-4">${entity.transferfee}</lable>
    </div><br>
    <div class="form-group ">
        <lable class="col-sm-4 text-right">承接手续费：</lable>
        <lable class="col-md-4">${entity.receptfee}</lable>
    </div><br>
</div>
</body>
</html>