...
<head>
    ...
    <script>
        ...
        function selectById(id) {
            var action = "${pageContext.request.contextPath}/admin/debtTransferAduit/selectById/" + id;
        ...
        function pass(){
            if(getCheckAudit()){
                ...
                var action = "${pageContext.request.contextPath}/admin/debtTransferAduit/auditDeal";
                var param = {
        ...
        function updateAuditPass(obj){
            if (checkFormAudit()){
                ...
                var action = "${pageContext.request.contextPath}/admin/debtTransferAduit/auditUpdate";
                var param = {
                    /*"audiTman": audiTman,
                     "auditTime": auditTime,*/
                    "remark": remark,
        ...
        function updateAuditNoPass(obj){
            if (checkFormAudit()){
                ...
                //提交按钮设置为不可用
                $("#crudType").attr("disabled",true);
                var action = "${pageContext.request.contextPath}/admin/debtTransferAduit/auditNoPassUpdate";
                var param = {
                    "remark": remark,
                }
                var callback = function (data) {
...
<div class="container" style="width:100%">
    <div class="row clearfix">
        <div class="col-md-12 column">
            <form action="${pageContext.request.contextPath}/admin/debtTransferAduit/lists" method="post" role="form"
            ...
            <table class="table  table-hover" id="personList_table">
                ...
                <c:forEach items="${pagehelper.list }" var="entity" varStatus="tendsta">
                    <tr class="text-center">
                        ...
                        <td>${entity.tenderserialnum}</td>
                        <td>${entity.tendernum}</td>
