...
<head>
    ...
    <script>
        ...
        //点击List列表页面中字段进行查询
        function selectByField(username,pno,type) {
            //清空查询条件
            resetmeragent();
            if (username != "") {
        ...
        function updateAuditPass(obj){
            if(getCheckAudit()){
                ...
                var action = "${pageContext.request.contextPath}/admin/depositRechargeRecord/auditSuccess";
                var param = {
        ...
        function noPass(){
            if(getCheck()){
                ...
                $("#checkvalue").val(check_val);
                var checkvalues = $("#checkvalue").val();
                var action = "${pageContext.request.contextPath}/admin/depositRechargeRecord/auditDeal";
                var param = {
                    "checkVal": checkvalues,
                }
                var callback = function (data) {
        ...
        function updateAuditNoPass(obj){
            if (checkFormAudit()){
                ...
                var action = "${pageContext.request.contextPath}/admin/depositRechargeRecord/auditFail";
                var param = {
                    "remark": remark,
                }
                var callback = function (data) {
        ...
        function updateAuditPassSingle(obj){
            ...
            var action = "${pageContext.request.contextPath}/admin/depositRechargeRecord/auditSuccessSingle";
            var param = {
                "mraid": obj,
            }
            var callback = function (data) {
        ...
        function NoPassSingle(objId){
            ...
            var action = "${pageContext.request.contextPath}/admin/depositRechargeRecord/auditDealSingle";
            var param = {
                "mraid": objId,
            }
            var callback = function (data) {
        ...
        function updateAuditNoPassSingle(obj){
            ...
            //按钮设置为不可用
            $("#crudType").attr("disabled",true);
            var action = "${pageContext.request.contextPath}/admin/depositRechargeRecord/auditFailSingle";
            var param = {
                "remark": remark,
            }
            var callback = function (data) {
...
<div class="container" style="width:80%">
    <div class="row clearfix">
        <div class="col-md-12 column">
            <form action="${pageContext.request.contextPath}/admin/depositRechargeRecord/auditList" method="post" role="form"
                ...
                <div class="col-md-9 form-inline" style="margin-top:15px;">
                    <div class="form-group">
                        <label>用户名:</label>
                        <input type="text" class="form-control" name="username" id="username" value="${depositRechargeRecord.username}" placeholder="输入用户名查询">&nbsp;&nbsp;
                        <%-- 用来存放选中的ID值 --%>
                        <input type="hidden" name="checkvalue" id="checkvalue" class="form-control" />
                    </div>
                    <div class="form-group">
                        <label>平台编号:</label>
                        <input type="text" class="form-control" name="pno" id="pno" value="${depositRechargeRecord.pno}" placeholder="输入用户名">&nbsp;&nbsp;
                    </div>
                    <div class="form-group">
                        <label>手充流水号:</label>
