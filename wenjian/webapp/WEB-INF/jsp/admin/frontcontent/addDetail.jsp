    ...
    <form id="form"  method="post"
        ...
        <c:if test="${frontType.subHrefSwitch eq 1}">
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    <input type="text" name="subHref" id="subHref" class="form-control"/>
		    ...
		    <c:if test="${frontType.thumbnailTitleSwitch eq 1}">
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input type="text" name="thumbnailTitle" id="thumbnailTitle" class="form-control" value="1"/>
            ...
            <c:if test="${frontType.thumbnailAddressSwitch eq 1}">
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input type="text" name="thumbnailAddress" id="thumbnailAddress" class="form-control" value="1"/>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-3">
                <input type="text" name="sort" id="sort" class="form-control" value="1"/>
        ...
        <c:if test="${frontType.thumbnailPicSwitch eq 1}">
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    <div style=" width:120px; height:120px;"><img id="ImgPr" width="120" height="120"/></div>
                </div>
            </div>
        ...
        <c:if test="${frontType.contentSwitch eq 1}">
            <textarea name="content" id="editor" style="width: 1000px;height:500px;"></textarea>
...
<script type="text/javascript">
   ...
   /*  $(function () {
    ...
    $("#insertButton").click(function(){
        ...
        //给表单字段定义验证规则
        if (bv.isValid()) {
        	var action="${pageContext.request.contextPath}/admin/frontContent/insertWithPic";
