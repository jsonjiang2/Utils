...
<script type="text/javascript">
	$(function(){
 	...
 	function settingShow(obj){
		var opid = $(obj).data("opid");
 		var url = basePath+"/admin/insidePagesSettings/settingShow";
	...
	function detailShow(obj){
		var opid = $(obj).data("opid");
		var url = basePath+"/admin/insidePagesSettings/detail";
		var callback = function(data){
 	...
 	function insert(){
		 ...
		 var callback = function(data){
			 alert(data.message);
			 if(data.code =="88"){
				 window.location.href=basePath+"/admin/insidePagesSettings/list";
			 }
		 }
		 var insertUrl = basePath+"/admin/insidePagesSettings/setting"
	...
	<div class="container" style="width: 85%;">
		<div class="row clearfix">
			...
			<div style="margin-top: 20px;"></div>
  			<jsp:include page="/WEB-INF/jsp/admin/insidepagessettings/insidePagesSettingsListTemp.jsp"></jsp:include>
		</div>
	</div>
	<!-- 引入模态框 -->
