    ...
    <div style="margin-top:20px;"></div>
        <form id="inputForm" class="form-horizontal" >
            ...
            <button class="btn btn-default" type="button"
                    onclick="window.location.href='${pageContext.request.contextPath}/admin/platformBackground/cxList';"
...
<script type="text/javascript">
    ...
    function save(){
        ...
        var action ="${pageContext.request.contextPath}/admin/platformBackground/save";
        $.post(action,params, function(data){
            alert(data.meta.message);
            $("#pid").val('');
            $("#pname").val('');
            $("#backgrounddepict").val('');
            window.location.href="${pageContext.request.contextPath}/admin/platformBackground/cxList";
        });
    }
