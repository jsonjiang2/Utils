		...
		<div class="row clearfix" id="div1">
			...
			<script type="text/javascript">
                $(document).ready(function(){  // 局部刷新 点击btn1按钮，让div1更新为需要显示的内容(这里显示新增页面)
                    $("#btn1").click(function(){
                        $('#div1').load('${pageContext.request.contextPath}/admin/platformBackground/addPage');
                    })
                })
			...
			<div id="queryall_list" style="margin-top: 30px;">
				<jsp:include page="/WEB-INF/jsp/admin/platformbackground/platformBackgroundTemp.jsp"></jsp:include>
			</div>
		</div>
	</div>
	<!-- 引入模态框 -->
