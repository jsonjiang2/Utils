	...
	<div class="container" style="width: 85%;">
		<div class="row clearfix" id="div1">
			...
			<form method="post"  class="form-inline" id="form-select"
				action="/admin/platformBusinessChangeRecord/cxList">
				...
				<div class="form-group">
					...
					<button type="button" class="btn btn-default" style="width: 100px;" id="btn1" onclick="addChange()">添加</button>
				</div>
			</form>

			<div style="margin-top: 20px;"></div>
			<div id="queryall_list" style="margin-top: 30px;">
				<jsp:include page="/WEB-INF/jsp/admin/platformbusinesschangerecord/platformBusinessChangeRecordTemp.jsp"></jsp:include>
			</div>
		</div>
	</div>
	<script type="text/javascript">
        function addChange() {
            $("#div1").load(basePath+"/admin/platformBusinessChangeRecord/addPage");
        }
	</script>
