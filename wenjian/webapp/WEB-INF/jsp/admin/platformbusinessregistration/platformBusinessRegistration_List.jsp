	...
	<div class="container" style="width: 85%;">
		<div class="row clearfix" id="div1">
			...
			<form method="post" class="form-inline" id="form-select"
				action="/admin/platformBusinessRegistration/cxList">
				...
				<div class="form-group">
					...
					<button type="button" class="btn btn-default" style="width: 100px;" id="btn1" onclick="addR()">添加</button>
				</div>
			</form>
			<div style="margin-top: 20px;"></div>
 			<jsp:include page="/WEB-INF/jsp/admin/platformbusinessregistration/platformBusinessRegistrationTemp.jsp"></jsp:include>
		</div>
	</div>
	<script type="text/javascript">
        function addR() {
            $("#div1").load(basePath+"/admin/platformBusinessRegistration/addPage");
        }
	</script>
	<!-- 引入模态框 -->
