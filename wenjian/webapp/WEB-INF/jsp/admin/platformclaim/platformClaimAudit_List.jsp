...
<div class="container" style="width: 85%;">
    <div class="row clearfix">
        ...
        <form method="post" class="form-inline" id="form-select"
              action="/admin/platformClaim/auditList">
            <input type="hidden" id="pageNum" name="pageNum">
            <input type="hidden" id="pageSize" name="pageSize">

            <div class="form-group">
                平台名称：<input class="form-control" type="text" id="pname" data-name=""
        ...
        <jsp:include page="/WEB-INF/jsp/admin/platformclaim/platformClaimAuditTemp.jsp"></jsp:include>
    </div>
</div>
<!-- 引入模态框 -->
