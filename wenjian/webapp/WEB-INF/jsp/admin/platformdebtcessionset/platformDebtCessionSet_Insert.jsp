...
<div class="container" style="margin-top: 25px;">
    <form class="form-horizontal" role="form" id="insertForm">
        <div class="form-group">
            ...
            <div class="col-sm-3">
                <input type="text" name="platformnum" id="platformnumss" class="form-control" onblur="findUserName();"/>
            ...
            <div class="form-group" id="minfeeDiv" >
                ...
                <div class="col-sm-3">
                    <input type="text" name="transferfee" id="transferfeeId" onkeyup="checkNum(this)" class="form-control"/>
            ...
            <div class="form-group" id="maxfeeDiv" >
                ...
                <div class="col-sm-3">
                    <input type="text" name="recepterfee" id="recepterfeeId" onkeyup="checkNum(this)" class="form-control"/>
        ...
        <div class="form-group" style="margin-left: 11%">
            <span style="color: red">注意:1.填写平台编号必须为已存在。</span><br/>
        </div>
