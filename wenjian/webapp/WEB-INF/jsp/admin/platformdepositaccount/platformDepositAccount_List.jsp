...
<head>
    ...
    <script>
        ...
        function selectById(id) {
            var action = "${pageContext.request.contextPath}/admin/platformDepositAccount/selectById/" + id;
...
<div class="container" style="width:80%">
    <div class="row clearfix">
        <div class="col-md-12 column">
            <form action="${pageContext.request.contextPath}/admin/platformDepositAccount/lists" method="post" role="form"
                  id="conditionForm">
                ...
                <div class="col-md-9 form-inline" style="margin-top:15px;">
                    <div class="form-group">
                        <label>平台编号:</label>
                        <input type="text" class="form-control" name="pno" id="pno" value="${platformDepositAccount.pno}" placeholder="输入平台编号查询">&nbsp;&nbsp;
                    </div>
                </div>
