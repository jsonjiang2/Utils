...
<div class="container">
    ...
    <form id="inputForm" class="form-horizontal" >
        ...
        <div class="form-group">
            ...
            <div class="col-sm-3">
                <textarea rows="6" class="form-control" name="brief" id="brief"></textarea>
            </div>
        </div>
        ...
        <button class="btn btn-default" type="button"
                onclick="window.location.href='${pageContext.request.contextPath}/admin/platformExecutives/cxList';"
...
<script type="text/javascript">
    ...
    $("#insertButton").click(function(){
        ...
        var action="/admin/platformExecutives/save";
