	...
	<div class="container" style="width: 85%;">
		<div class="row clearfix" id="div1">
			...
			<form method="post"  class="form-inline" id="form-select"
				action="/admin/platformExecutives/cxList">

				<!--该表单提交查询条件，然后去执行platformExecutives/cxList方法 注意这里的action-->
				...
				<div class="form-group">
					...
					<button type="button" class="btn btn-default" style="width: 100px;" id="btn1">新增高管</button>
				</div>
			</form>

			<div style="margin-top: 20px;"></div>
			<div id="queryall_list" style="margin-top: 30px;">
				<jsp:include page="/WEB-INF/jsp/admin/platformexecutives/platformExecutivesTemp.jsp"></jsp:include>
			</div>
		</div>
	</div>
	<script type="text/javascript">
        $(document).ready(function(){  // 局部刷新 点击btn1按钮，让div1更新为需要显示的内容(这里显示新增页面)
            $("#btn1").click(function(){
                $('#div1').load('${pageContext.request.contextPath}/admin/platformExecutives/addPage');
            })
        })
