...
<head>
    ...
    <script type="text/javascript">
        function queryauditstatus(auditstatus){
...
<div class="container" style="width: 85%;">
    <div class="row clearfix" id="div1">
        ...
        <form method="post"  class="form-inline" id="form-select"
              action="/admin/platformInfo/auditList">
            ...
            &nbsp;&nbsp;
            <div class="form-group">
                审核状态： <select id="auditstatus" name="auditstatus" class="form-control" data-status="">
        ...
        <div id="queryall_list" style="margin-top: 30px;">
            <jsp:include page="/WEB-INF/jsp/admin/platforminfo/platformAuditTemp.jsp"></jsp:include>
        </div>
    </div>
</div>
<script type="text/javascript">
