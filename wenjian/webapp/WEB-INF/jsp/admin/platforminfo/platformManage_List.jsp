...
<head>
    ...
    <script type="text/javascript">
        ...
        function queryoperatingstatus(status){
...
<div class="container" style="width: 85%;">
    <div class="row clearfix">
        ...
        <form method="post" class="form-inline" id="form-select"
              action="/admin/platformInfo/manageList">
        ...
        <jsp:include page="/WEB-INF/jsp/admin/platforminfo/platformManageTemp.jsp"></jsp:include>
    </div>
</div>
<!-- 引入模态框 -->
