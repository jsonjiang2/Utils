	...
	<div class="container" style="width: 85%;">
		<div class="row clearfix" id="div1">
			...
			<form method="post"  class="form-inline" id="form-select"
				action="/admin/platformOwnershipChangeRecord/cxList">
			...
			<div id="queryall_list" style="margin-top: 30px;">
				<jsp:include page="/WEB-INF/jsp/admin/platformownershipchangerecord/platformOwnershipChangeRecordTemp.jsp"></jsp:include>
			</div>
		</div>
	</div>
	<script type="text/javascript">
