...
<%-- 	<div class="row" style="margin-top: 10px;">
	...
	<div class="row" style="margin-top: 10px;">
		<div class="col-md-10 col-md-offset-1">
			...
			<span id="tenderidlb">
				<c:if test="${preCommonMember.businesssource eq '1'}">网贷类</c:if>
				<c:if test="${preCommonMember.businesssource eq '2'}">证券类</c:if>
				<c:if test="${preCommonMember.businesssource eq '3'}">现金贷</c:if>
				<c:if test="${preCommonMember.businesssource eq '4'}">银行低息</c:if>
				<c:if test="${preCommonMember.businesssource eq '5'}">股票配资</c:if>
			</span>
		</div>
		<hr/>
	</div>
	...
	<div class="row" style="margin-top: 10px;">
		<div class="col-md-12" style="margin-top:10px;">
			<span class="col-md-4 text-right" style="margin-left: 17px;">注册前URL&nbsp;:</span>
			<span class="col-md-6" style="margin-top: -17px;margin-left: -15px;">
				${preCommonMember.beforeregisterurl}
			</span>
			<hr/>
		</div>
		<hr/>
	...
	<%--<div class="row" style="margin-top: 10px;">
		<div class="col-md-10 col-md-offset-1">
			<span class="col-sm-4 text-right">注册前URL&nbsp;:</span>
			<span id="tenderidlb">
				${preCommonMember.beforeregisterurl}
			</span>
		</div>
	...
	<div class="row" style="margin-top: 10px;">
		<div class="col-md-10 col-md-offset-1">
			...
			<span id="tenderidlb">
				<c:if test="${empty preCommonMember.cookie}">
					--
				</c:if>
				<c:if test="${!empty preCommonMember.cookie}">
					${preCommonMember.cookie}
				</c:if>
			</span>
		</div>
		<hr/>
	...
	<div class="row" style="margin-top: 10px;">
		<div class="col-md-10 col-md-offset-1">
			<span class="col-sm-4 text-right">资源主ID&nbsp;:</span> 
			<span id="tenderidlb"> 
				<c:if test="${empty preCommonMember.xmflogouid }">
					--
				</c:if>
				<c:if test="${!empty preCommonMember.xmflogouid }">
					${preCommonMember.xmflogouid }
				</c:if>
			</span>
		</div>
		<hr/>
