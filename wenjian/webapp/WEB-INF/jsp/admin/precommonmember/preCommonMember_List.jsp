...
$(function(){
	...
	$("#isadmin_select").val("${preCommonMember.isadmin}");
	$("#businesssource_select").val("${preCommonMember.businesssource}");
	$("#hisurl_select").val("${preCommonMember.beforeregisterurl}");
		...
		<div style="float: left;">
			<form method="post" action="list" id="form-select" class="form-inline">
				<div style="margin-top: 18px;margin-bottom: 10px">
					...
					<div class="form-group">
						注册前URL：<input class="form-control" type="text" id="hisurl_select"
								   name="beforeregisterurl" style="text-align: center; line-height: 18px;"
								   placeholder="填写注册前URL">
					</div>
					<div class="form-group"  style="margin-top: 10px">
                        <label>是否管理员:</label>
                    ...
                    <div class="form-group"  style="margin-top: 10px">
                        <label>业务类型:</label>
                        <select class="form-control" name="businesssource" id="businesssource_select">
                            <option value="">全部</option>
                            <option value="1">网贷类</option>
                            <option value="2">证券类</option>
                            <option value="3">现金类</option>
                            <option value="4">银行低息</option>
                            <option value="5">股票配资</option>
                        </select>&nbsp;&nbsp;
                    </div>
