...
<head>
    ...
    <script type="text/javascript">
        ...
        function deatilUI(id){
            var action = "${pageContext.request.contextPath}/admin/detil/selectById/" + id;
...
<div class="container" style="width: 80%;">
    <div class="row clearfix">
        <div class="col-md-12 column">
            <form action="${pageContext.request.contextPath}/admin/detil/lists" method="post" role="form" id="conditionForm">
                <input type="hidden" id="pageNum" name="pageNum"/>
                <input type="hidden" id="pageSize" name="pageSize"/>
                <div class="col-md-9 form-inline" style="margin-top:15px;">
                    <div class="form-group">
                        <label>用户名:</label>
                        <input type="text" class="form-control" name="username" id="username" value="${pcmd.username}" placeholder="填写用户名">&nbsp;&nbsp;
                    </div>
                   <%--   <div class="form-group">
                        <label>授权码:</label>
                        <input type="text" class="form-control" name="uin" id="uin" value="${pcmd.uin}" placeholder="填写授权码">&nbsp;&nbsp;
                    </div> --%>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="isbind" id="isbind">
                            ...
                            <option value="1" <c:if test="${pcmd.isbind==1}">selected</c:if>>已绑定</option>
                            <option value="2" <c:if test="${pcmd.isbind==2}">selected</c:if>>已解绑</option>
                        </select>&nbsp;&nbsp;
                    </div>
                     ...
                     <div class="form-group">
                        ...
                        <select class="form-control" name="type" id="type">
                            <option value="">全部</option>
                            <option value="1" <c:if test="${pcmd.type==1}">selected</c:if>>QQ</option>
                            <option value="2" <c:if test="${pcmd.type==2}">selected</c:if>>微信</option>
                            <option value="3" <c:if test="${pcmd.type==3}">selected</c:if>>微博</option>
                        </select>&nbsp;&nbsp;
                    </div>
