				...
				<tbody>
					<c:forEach items="${pagehelper.list}" var="item" varStatus="status">
						<tr class="text-center">
							...
							<td>
								<a href="${basePath}/admin/preForumThread/viewList?authorid=${item.authorid}"  style="color:blue;">
							...
							<td>
 	 						...
 	 						<td>	
	 							 <a href="${basePath}/admin/preForumThread/viewList?fid=${item.fid}"  style="color:blue;">
							...
							<td>
								<a href="${basePath}/admin/preForumThread/viewList?displayorder=${item.displayorder}"  style="color:blue;">
									<c:choose>
