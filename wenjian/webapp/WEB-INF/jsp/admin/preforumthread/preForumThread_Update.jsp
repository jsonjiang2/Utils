...
<script type="text/javascript"
	src="${basePath}/static/plugin/calendar/WdatePicker.js"></script>
<script type="text/javascript">
	$(function(){
...
<body>
    ...
    <form class="form-horizontal" role="form" id="threadUpdateForm">
	    ...
	    <div class="form-group">
            <label class="col-sm-2 control-label laber_from" for="presubject">点击量：</label>
            <div class="col-sm-3">
                     <input type="text" name="views" id="views" class="form-control" value="${preForumThread.views }"/>
             </div>
        </div>
        
        <div class="form-group">
            <label class="col-sm-2 control-label laber_from" for="presubject">发帖时间：</label>
            <div class="col-sm-3">
            		<wdb:formatDate value="${preForumThread.dateline }" var="dateline">
            			
	                   <input type="text" style="width:220px;height:36px;" name="datelinestr" id="datelinestr" class="Wdate" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" value="${dateline }"/>
            		</wdb:formatDate>
             </div>
        </div>
