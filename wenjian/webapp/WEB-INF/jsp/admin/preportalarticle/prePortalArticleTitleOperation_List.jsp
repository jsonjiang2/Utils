...
<body>
	<div class="container" style="width: 85%;">
		<div class="row clearfix">
			...
			<form method="post" class="form-inline" id="form-operation-select"
				...
				&nbsp;&nbsp;
				<div class="form-group">
					 <select class="form-control" name="status" id="select-status-text" data-status="${prePortalArticleTitle.status }">
			...
			<jsp:include page="/WEB-INF/jsp/admin/preportalarticle/prePortalArticleTitleOperationListTemp.jsp"></jsp:include>
		</div>
	</div>
	<!-- 引入模态框 -->
