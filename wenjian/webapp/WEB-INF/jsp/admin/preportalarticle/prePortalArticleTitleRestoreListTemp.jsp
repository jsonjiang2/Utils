...
<table class="table table-hover" id="personList_table">
				<thead>
					<tr class="text-center" style="background: #ccc;">
						<td>
							<input type="checkbox" id="allRestore" class="myCheck" onclick="PrePortalArticleTitle.checkRestoreAll()">
						</td>
						<td>序号</td>
						<td>论坛名称</td>
						<td>审核状态</td>
				...
				<tbody>
					<c:forEach items="${pagehelper.list}" var="item" varStatus="status">
						<tr class="text-center">
							<td>
								<input type="checkbox" name="checkRestoreName" class="myCheck" value="${item.aid}" />
							</td>
							...
							<td>${item.sort }</td>
							<td>
  								<button type="button" class="btn btn-default" onclick="PrePortalArticleTitle.restore(this)" data-opid="${item.aid}">恢复</button>
 							</td>
							<td>
			...
			<button type="button" class="btn btn-default" onclick="PrePortalArticleTitle.restoreBatch(this)">批量恢复</button>
