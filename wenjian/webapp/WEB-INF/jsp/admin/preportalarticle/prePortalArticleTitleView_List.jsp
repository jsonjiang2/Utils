...
<body>
	<div class="container" style="width: 85%;">
		<div class="row clearfix">
			...
			<form method="post" class="form-inline" id="form-view-select"
				action="viewlist">
			...
			<jsp:include page="/WEB-INF/jsp/admin/preportalarticle/prePortalArticleTitleViewListTemp.jsp"></jsp:include>
		</div>
	</div>
	<!-- 引入模态框 -->
