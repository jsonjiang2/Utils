...
<table class="table table-hover" id="personList_table">
				<thead>
					<tr class="text-center" style="background: #ccc;">
						<td>
							<input type="checkbox" id="allRestore" class="myCheck" onclick="PreReply.checkRestoreDelAll()">
						</td>
						<td>序号</td>
						<td>发布人</td>
						<td>回复标题</td>
				...
				<tbody>
					<c:forEach items="${vos}" var="item" varStatus="status">
						<tr class="text-center">
							<td>
								<input type="checkbox" name="checkRestorename" class="myCheck" value="${item.id}">
							</td>
							<td>${status.index+1}</td>
							<td>
								<a href="${basePath}/admin/preReply/restoreList?uid=${item.uid }"  style="color:blue;">
 							...
 							<td>
 								 <a href="${basePath}/admin/preReply/restoreList?cid=${item.cid}" style="color:blue;">
							...
							<td>
	 						...
	 						<td>	
	 							<a href="${basePath}/admin/preReply/restoreList?typeid=${item.typeid}"  style="color:blue;">
		 							 <c:choose>
		 					...
		 					<td>
		 						<a href="${basePath}/admin/preReply/restoreList?status=${item.status}"  style="color:blue;">
									<c:choose>
							...
							<td>
  							...
  							<td>
  	 							<button class="btn btn-default"  onclick="PreReply.restorePreReply(this)" data-opid="${item.id}" data-audit="1">恢复</button>
			...
			<button class="btn btn-default"  onclick="PreReply.restoreBatchPreReply(this)">批量恢复</button>
 			<div id="page_div" style="margin-top: 20px;">
				<%@ include file="/WEB-INF/jsp/common/pagehelper4.jsp"%>
			</div>