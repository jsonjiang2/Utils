	...
	<div class="container" style="width: 85%;">
		<div class="row clearfix">
			...
			<form method="post" class="form-inline" id="form-view-select"
				...
				&nbsp;&nbsp;
 			<div class="form-group">
					标题类型： <select id="select-typeid-text" name="typeid" class="form-control" data-typeid="${preReply.typeid}">
			...
			<div style="margin-top: 20px;"></div>
 			<jsp:include page="/WEB-INF/jsp/admin/prereply/preReplyViewListTemp.jsp"></jsp:include>
		</div>
	</div>
	<!-- 引入模态框 -->
