...
<script type="text/javascript">
	$(function(){
		...
		$("#select-status-text").val("${resourcesChannelInfo.status}");
	...
	<div class="container" style="width: 85%;">
		<div class="row clearfix">
			...
			<form method="post" class="form-inline" id="form-select"
				...
				&nbsp;&nbsp;
 				<div class="form-group">
					审核状态： <select id="select-status-text" name="status" class="form-control" data-status="">
			...
			<div style="margin-top: 20px;"></div>
 			<jsp:include page="/WEB-INF/jsp/admin/resourceschannelinfo/resourcesChannelInfoView.jsp"></jsp:include>
		</div>
	</div>
	<!-- 引入模态框 -->
