...
<script type="text/javascript">
	$(function(){
		$("#select-username-text").val("${resourcesInfo.username}");
		$("#select-pname-text").val("${resourcesInfo.pname}");
		$("#select-type-text").val("${resourcesInfo.type}");
	})
</script>
</head>
<body>
	<div class="container" style="width: 85%;">
		<div class="row clearfix">
			...
			<div style="margin-top: 20px;"></div>
 			<jsp:include page="/WEB-INF/jsp/admin/resourcesinfo/resourcesInfoTemp.jsp"></jsp:include>
		</div>
	</div>
	<!-- 引入模态框 -->
