...
<script type="text/javascript">
	$(function(){
		$("#select-username-text").val("${resourcesUserLink.username}");
		$("#select-pname-text").val("${resourcesUserLink.pname}");
		$("#select-status-text").val("${resourcesUserLink.status}");
	})
</script>
</head>
<body>
	<div class="container" style="width: 85%;">
		<div class="row clearfix">
			...
			<form method="post" class="form-inline" id="form-select"
				...
				<input type="hidden" id="pageSize" name="pageSize">
 				<div class="form-group">
					承接人：<input class="form-control" type="text" id="select-username-text" data-name=""
			...
			<div style="margin-top: 20px;"></div>
 			<jsp:include page="/WEB-INF/jsp/admin/resourcesuserlink/resourcesUserLinkTemp.jsp"></jsp:include>
		</div>
	</div>
	<!-- 引入模态框 -->
