...
<div class="col-md-12" id="rechargei">
    <div class="row text-center" style="line-height: 0px;">
        <font size="5" style="font-weight:500;">打赏记录详情</font>
    </div><br>
    ...
    <div class="form-group ">
        <lable class="col-sm-4 text-right">打赏用户名-姓名：</lable>
    ...
    <div class="form-group ">
        <lable class="col-sm-4 text-right">受赏用户名-姓名：</lable>
        <lable class="col-md-4">
    ...
    <div class="form-group ">
        <lable class="col-sm-4 text-right">打赏帖子ID：</lable>
        <lable class="col-md-4">${entity.pfttid}</lable>
    </div><br>

    <div class="form-group ">
        <lable class="col-sm-4 text-right">打赏流水号：</lable>
        <lable class="col-md-6">${entity.rewardno}</lable>
    </div><br>
    ...
    <div class="form-group ">
        <lable class="col-sm-4 text-right">打赏类型：</lable>
        <lable class="col-md-4">
    ...
    <div class="form-group ">
        <lable class="col-sm-4 text-right">打赏金额：</lable>
        <lable class="col-md-4">
            <fmt:formatNumber value="${entity.rewardamount}" pattern="0.00" maxFractionDigits="2" />元
        </lable>
    </div><br>

    <div class="form-group ">
        <lable class="col-sm-4 text-right">打赏时间：</lable>
        <lable class="col-md-4">
    ...
    <div class="form-group ">
        <lable class="col-sm-4 text-right">打赏状态：</lable>
        <lable class="col-md-4">
    ...
    <c:if test="${not empty entity.cookiename}">
        <div class="form-group ">
            <label class="col-sm-4 text-right">cookie：</label>
            <label class="col-md-6">${entity.cookiename}</label>
        </div>
    </c:if>
