...
<div class="container">
    <form id="form" action="" method="post" class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-3">
                <input type="text" name="smscname" id="smscname" class="form-control" value="${smsChannel.smscname}"/>
                <span id="smscnameError" style="color:red"></span>
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-2 control-label">短信公司</label>
            <div class="col-sm-3">
                <input type="text" name="smsccompany" id="smsccompany" class="form-control" value="${smsChannel.smsccompany}"/>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-3">
                ...
                <span id="passnoError" style="color:red"></span>
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-2 control-label">短信类型</label>
            <div class="col-sm-3">
                <select name="smstype" id="smstype" class="form-control">
                    <option value="">请选择</option>
                    <option value="1">通知类</option>
                    <option value="2">营销类</option>
                </select>
                <span id="smstypeError" style="color:red"></span>
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-2 control-label">短信接口版本</label>
            <div class="col-sm-3">
                <input type="text" name="smsvertion" id="smsvertion" class="form-control" value="${smsChannel.smsvertion}"/>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-3">
                <input type="text" name="smsurl" id="smsurl" class="form-control" value="${smsChannel.smsurl}"/>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-3">
                <input type="text" name="serialno" id="serialno" class="form-control" value="${smsChannel.serialno}"/>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-3">
                <input type="text" name="keyno" id="keyno" class="form-control" value="${smsChannel.keyno}"/>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-3">
                <input type="text" name="pass" id="pass" class="form-control" value="${smsChannel.pass}"/>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-3">
                <input type="text" name="action" id="action" class="form-control" value="${smsChannel.action}"/>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-3">
                <input type="text" name="extno" id="extno" class="form-control" value="${smsChannel.extno}"/>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-3">
                <input type="text" name="pusername" id="pusername" class="form-control" value="${smsChannel.pusername}"/>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-3">
                <input type="text" name="ppassword" id="ppassword" class="form-control" value="${smsChannel.ppassword}"/>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-3">
                <select name="isuse" id="isuse" class="form-control">
                    <option value="">请选择</option>
                    <option value="1" <c:if test="${smsChannel.isuse==1}">selected</c:if>>是</option>
                    <option value="0" <c:if test="${smsChannel.isuse==0}">selected</c:if>>否</option>
                </select>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-3">
                <textarea rows="3" class="form-control" name="channelremark" id="channelremark">${smsChannel.channelremark}</textarea>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-3">
                <textarea rows="3" class="form-control" name="remark" id="remark">${smsChannel.remark}</textarea>
                <span id="remarkError" style="color:red"></span>
            </div>
        </div>
        <input type="hidden" name="id" value="${smsChannel.id}"/>
    </form>
</div>
