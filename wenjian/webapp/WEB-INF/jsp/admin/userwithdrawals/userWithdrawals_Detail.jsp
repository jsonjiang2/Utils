...
<div class="row" style="line-height: 0px;">
    <font class="col-sm-4 text-right">异常状态：</font>
    <font class="col-md-4">
        <c:if test="${entity.abnormalstatus==0 }"><font color="gray">未验证</font></c:if>
        <c:if test="${entity.abnormalstatus==1 }"><font color="blue">验证通过</font></c:if>
        <c:if test="${entity.abnormalstatus==2 }"><font color="red">异常</font></c:if>
    </font>
    <hr>
</div>
<div class="row" style="line-height: 0px;">
    <font class="col-sm-4 text-right">提现异常处理时间：</font>
    <font class="col-md-4">
        <c:if test="${not empty entity.abnormaldealtime}">
            ${sf.format(entity.abnormaldealtime)}
        </c:if>
    </font>
    <hr>
</div>
<div class="row" style="line-height: 0px;">
    <font class="col-sm-4 text-right">提现异常处理人：</font>
    <font class="col-md-4">
        <c:if test="${not empty entity.abnormaldealid}">
            <wdb:getAdminUser uid="${entity.abnormaldealid}" var="auid">
                ${auid.username}-${auid.fullname ? '无' : auid.fullname}
            </wdb:getAdminUser>
        </c:if>
    </font>
...
<div class="row" style="line-height: 0px;">
    <font class="col-sm-4 text-right">是否通知：</font>
    <font class="col-md-4">
        <c:if test="${entity.ischeck==0 }"><font color="gray">未通知</font></c:if>
        <c:if test="${entity.ischeck==1 }"><font color="blue">已通知</font></c:if>
    </font>
    <hr>
</div>
<div class="row" style="line-height: 0px;">
