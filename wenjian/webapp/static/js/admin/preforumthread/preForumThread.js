var PreForumThread = {
		...
		auditPass:function(obj){
			...
			var callback = function(data){
				...
				if(data.meta.code == "88"){
					window.location.href = basePath+"/admin/preForumThread/list";
				}
			}
		...
		auditBatchPass:function(obj){
			...
			var audit = $(obj).data("audit");
			var ismobile = $(obj).data("ismobile");
 			var url = basePath+"/admin/preForumThread/auditBatchPass";
			var callback = function(data){
				alert(data.meta.message);
				if(data.meta.code == "88"){
					window.location.href = basePath+"/admin/preForumThread/list";
		...
		del:function(obj){
			...
			var callback = function(data){
				alert(data.meta.message);
				if(data.meta.code == "88"){
					window.location.href = basePath+"/admin/preForumThread/delList";
				}
			}
		...
		restoreThread:function(obj){
			...
			var opid = $(obj).data("opid");
 			var url = basePath+"/admin/preForumThread/restoreThread";
			var callback = function(data){
				alert(data.meta.message);
				if(data.meta.code == "88"){
					window.location.href = basePath+"/admin/preForumThread/restoreList";
				}
			}
		...
		updShow:function(obj){
			var opid = $(obj).data("opid");
			var url = basePath+"/admin/preForumThread/updShow";
			var callback = function(data){
  		...
  		upd:function(obj){
 			...
 			var url = basePath+"/admin/preForumThread/upd";
			var callback = function(data){
				alert(data.meta.message);
				if(data.meta.code == "88"){
					 $("#updateModal").modal({
 		...
 		detail:function(opid){
  			var action = basePath+"/admin/preForumThread/detail/"+opid;
 			var callback = function(data){
 				 $("#detailsModal").modal({
 					 show:true
 				  });
 		...
 		addMobileH5:function(obj){
			...
			var opid = $(obj).data("opid");
			var url = basePath+"/admin/preForumThread/addMobileH5";
			var callback = function(data){
				  alert(data.message);
 				  if(data.code =="88"){
 					 window.location.href = basePath+"/admin/preForumThread/delList";
...
var PreForumThreadFocu = {
		...
		auditPass:function(obj){
			...
			var callback = function(data){
				alert(data.meta.message);
				if(data.meta.code == "88"){
					window.location.href = basePath+"/admin/preForumThread/focuList";
				}
			}
			$.post(url,{"tid":opid,"audit":audit,"ismobile":ismobile},callback);
		},
