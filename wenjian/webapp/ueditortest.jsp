...
<div>
    <h1>完整demo</h1>
    <label>标题：</label>
    <input style="margin-top:15px;margin-bottom:15px;width:280px;height:30px;"class="from-contol" type="text" name="subject" id="subject" value="测试测试标题"> 
    <script id="editor" type="text/plain" style="width:1024px;height:500px;"></script>
</div>
<div id="btns">
    <div>
    	<button style="margin-top:25px;" class="btn btn-default" onclick="saveHtml()">保存帖子信息</button>
...
<script type="text/javascript">
    ...
    function saveHtml(){
    	...
    	var callback = function(data){
     	...
     	$.post(url,{"subject":subject,"content":content,"fid":40},callback);
    }
